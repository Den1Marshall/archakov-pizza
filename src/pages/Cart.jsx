    ...
    <Container maxWidth='md' className={styles.container}>
      <section className={styles.cart}>
        ...
        <section className={styles.bottom}>
          <p className={styles.bottomAmount}>
            Всего пицц: <strong>{totalAmount} шт.</strong>
          </p>
          <p className={styles.bottomTotal}>
            Сумма заказа: <strong>{totalPrice} ₴</strong>
          </p>
          <Link to='/'>
            <button className={`${styles.bottomBtn} ${styles.bottomBtnBack}`}>
              НАЗАД
            </button>
          </Link>
          <button className={`${styles.bottomBtn} ${styles.bottomBtnPay}`}>
            Оплатить сейчас
          </button>
        </section>
      </section>
